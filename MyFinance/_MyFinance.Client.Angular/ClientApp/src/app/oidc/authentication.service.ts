...
import { UserManagerSettings } from './auth.client.settings';
...
export class AuthenticationService {
    ...
    private getUserManager() {
        if (!this._userManager) {
            ...
            userManagerSettings.redirect_uri = 'http://localhost:11001/login-callback'; //start login process
            userManagerSettings.post_logout_redirect_uri = 'http://localhost:11001/logout-callback'; //start logout process

            userManagerSettings.automaticSilentRenew = true;
            userManagerSettings.silent_redirect_uri = 'http://localhost:11001/silent-callback'; //silent renew oidc doing it automaticly 
